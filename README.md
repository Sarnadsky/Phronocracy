...
|----------|--------|------|
| English | Markdown | [`docs/en/Phronocracy_EN.md`](docs/en/Phronocracy_EN.md) |
| English | PDF | [`docs/en/Phronocracy_EN.pdf`](docs/en/Phronocracy_EN.pdf) |
| Russian | Markdown | [`docs/ru/Phronocracy_RU.md`](docs/ru/Phronocracy_RU.md) |
| Russian | PDF | [`docs/ru/Phronocracy_RU.pdf`](docs/ru/Phronocracy_RU.pdf) |

### Citation

See [`CITATION.md`](CITATION.md) for detailed citation formats.
...
Licensed under [Creative Commons BY-NC-SA 4.0](LICENSE.md) — free to share and adapt with attribution, non-commercial use, share-alike requirement.
...
| Язык | Формат | Файл |
|------|--------|------|
| Английский | Markdown | [`docs/en/Phronocracy_EN.md`](docs/en/Phronocracy_EN.md) |
| Английский | PDF | [`docs/en/Phronocracy_EN.pdf`](docs/en/Phronocracy_EN.pdf) |
| Русский | Markdown | [`docs/ru/Phronocracy_RU.md`](docs/ru/Phronocracy_RU.md) |
| Русский | PDF | [`docs/ru/Phronocracy_RU.pdf`](docs/ru/Phronocracy_RU.pdf) |

### Цитирование

См. [`CITATION.md`](CITATION.md) для подробных форматов цитирования.
...
Лицензировано под [Creative Commons BY-NC-SA 4.0](LICENSE.md) — свободно для распространения и адаптации с указанием авторства, некоммерческое использование, требование share-alike.
